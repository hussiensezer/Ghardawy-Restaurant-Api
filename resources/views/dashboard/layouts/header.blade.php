    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="modern admin logo" src="{{URL::asset('assets/app-assets/images/logo/logo.svg')}}">
                        <h3 class="brand-text">Gharadawy</h3>
                    </a></li>
